$(function(){
    function motorcycleColoursSpinnerAna(ctaText,nextPageURL,tankPrice,arrowClicked){
        dataLayer.push({
            'event':'motorcycleColoursSpinner',
            'eventCategory':'motorcycleColoursSpinner',
            'eventAction':ctaText,
...
$(document).on("click",".tanks-slider .slick-list .slick-track .slick-slide",function(){
    let nextPageURL = $(this).attr("href");
    if(nextPageURL == undefined || nextPageURL == "#"){
        nextPageURL = ""
    }
    let ctaText =  $(this).children("div").children("div").children(".tanks-size").children("h3").text().trim();
    let tankPrice = $(this).children("div").children("div").children(".tanks-size").children(".changing-price").text().trim();
    motorcycleColoursSpinnerAna(ctaText,nextPageURL,tankPrice,"");
});

$(document).on("click",".tanks-slider .slick-arrow",function(){
    let arrowClicked = $(this).attr("aria-label");
    let nextPageURL = $(this).attr("href");
    if(nextPageURL == undefined || nextPageURL == "#"){
        nextPageURL = ""
    }
    let tankPrice = $(this).siblings(".slick-list").children(".slick-track").children(".slick-current").children("div").children("div").children(".tanks-size").children(".changing-price").text().trim();
    motorcycleColoursSpinnerAna("Arrow",nextPageURL,tankPrice,arrowClicked);
});

$(document).on("click",".specification-section .specss",function(){
    let ctaText =  $(this).text().trim();
    let nextPageURL = $(this).attr("href");
    if(nextPageURL == undefined || nextPageURL == "#"){
        nextPageURL = ""
    }
    let tankPrice = $(".tanks-slider").children(".slick-list").children(".slick-track").children(".slick-current").children("div").children("div").children(".tanks-size").children(".changing-price").text().trim();
    motorcycleColoursSpinnerAna(ctaText,nextPageURL,tankPrice,"");
});

$(document).on("click",".makeitYoursBtnAna",function(){
    let ctaText =  $(this).text().trim();
    let nextPageURL = $(this).attr("href");
    if(nextPageURL == undefined || nextPageURL == "#"){
        nextPageURL = ""
    }
    let tankPrice = $(".tank-spec-container").children(".tanks-slider").children(".slick-list").children(".slick-track").children(".slick-current").children("div").children("div").children(".tanks-size").children(".changing-price").text().trim();
    motorcycleColoursSpinnerAna(ctaText,nextPageURL,tankPrice,"");
});
...
$(document).ready(function () {
    ...
    let bikeColorCode = $(".tanks-slider").children(".slick-list").children(".slick-track").children(".slick-current").children("div").children("div").children(".tanks-size").attr("bg-color-change");
    if (bikeColorCode) {
        $("#tank-bg-change").attr("style", "background-color:" + bikeColorCode);
    }

    $(document).on("click", ".tanks-slider .slick-list .slick-track .slick-slide", function () {
        let selectedColor = $(this).children("div").children("div").children(".tanks-size").attr("bg-color-change");
        if (selectedColor) {
            $("#tank-bg-change").attr("style", "background-color:" + selectedColor);
        }
    });

    $(document).on("click", ".tanks-slider .slick-arrow", function () {
        let selectedColor = $(this).siblings(".slick-list").children(".slick-track").children(".slick-current").children("div").children("div").children(".tanks-size").attr("bg-color-change");
        if (selectedColor) {
            $("#tank-bg-change").attr("style", "background-color:" + selectedColor);
        }
    });
