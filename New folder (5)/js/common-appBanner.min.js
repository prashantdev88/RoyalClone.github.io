...
$(document).on('click','.videoAppAnalyticsBtn',function(){
  let ctaText = $(this).text().trim();
  let nextUrl = $(this).attr("href");
  let heading = $(this).parent(".app-btn").siblings(".analyticsHeading").text().trim();
   if(!nextUrl){
    nextUrl = "";
   }
...
$(document).on('click','.appAnalyticsBtn',function(){
  let ctaText = $(this).children("img").attr("alt");
  let nextUrl = $(this).attr("href");
  let heading = $(this).parent(".app-btn").siblings(".analyticsHeading").text().trim();
   if(!nextUrl){
    nextUrl = "";
